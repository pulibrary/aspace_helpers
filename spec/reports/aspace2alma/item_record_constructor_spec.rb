...
RSpec.shared_context 'with common mocks' do
  ...
  let(:constructor) do
    validator = instance_double(AlmaReportBarcodeValidation, valid?: true)
  ...
  let(:params) { Params.new(mock_doc, mock_tag099_a, mock_log_out, nil) }
  let(:mock_top_container) { instance_spy(TopContainer) }
end
...
RSpec.describe ItemRecordConstructor do
