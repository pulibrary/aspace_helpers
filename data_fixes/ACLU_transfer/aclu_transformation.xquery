...
(:This assumes some preliminary cleanup in the data file, especially removing the office/table/text/calcext namespaces and prefixes and expanding the number-columns-repeated columns:)

declare variable $aclu as document-node()+ := doc("file:/Users/heberleinr/Documents/aspace_helpers/data_fixes/Transferred_to_Princeton-December2017.xml");
